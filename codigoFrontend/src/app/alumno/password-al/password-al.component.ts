...
import { PasswordAlService } from './password-al.service';
import { ActivatedRoute, Router } from '@angular/router';
import swal from 'sweetalert2';
import { AuthService } from '../../login/auth.service';

@Component({
  selector: 'app-password-al',
  templateUrl: './password-al.component.html',
  styleUrls: ['./password-al.component.css']
})
export class PasswordAlComponent implements OnInit {
  ...
  constructor(private changePasswordService: PasswordAlService, private activatedRoute: ActivatedRoute,
