...
import { PasswordAdmService } from './password-adm.service';
import { ActivatedRoute, Router } from '@angular/router';
import swal from 'sweetalert2';
import { AuthService } from '../../login/auth.service';

@Component({
  selector: 'app-password-adm',
  templateUrl: './password-adm.component.html',
  styleUrls: ['./password-adm.component.css']
})
export class PasswordAdmComponent implements OnInit {
  ...
  constructor(private changePasswordService: PasswordAdmService, private activatedRoute: ActivatedRoute,
